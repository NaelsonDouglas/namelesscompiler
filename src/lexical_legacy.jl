...
function token(lexem,line::Int, col::Int)
	...
	elseif lexem[1] == '"' && lexem[length(lexem)] == '"' #if it starts and ends with \"
		tkn["categ_nom"] = "TYPE_STRING"
	elseif lexem[1] == '\'' && lexem[length(lexem)] == '\'' #if it starts and ends with \"
		tkn["categ_nom"] = "TYPE_CHAR"
	else #From this point we are sure the token is not a number and doesnt start with a number
		if lexem == "["
			tkn["categ_nom"] = "O_BRACKET"			
		elseif lexem == "]"
			tkn["categ_nom"] = "C_BRACKET"		
		elseif lexem == "("
			tkn["categ_nom"] = "O_PARENTHESIS"		
		elseif lexem == ")"
			tkn["categ_nom"] = "C_PARENTHESIS"		
		elseif lexem == ","
			tkn["categ_nom"] = "COMMA"		
		elseif lexem == ";"
			tkn["categ_nom"] = "SMCL"					
		elseif lexem == "("
			tkn["categ_nom"] = "O_PARENTHESIS"		
		elseif lexem == "{"
			tkn["categ_nom"] = "O_CURLY_BRACKET"		
		elseif lexem == "}"
			tkn["categ_nom"] = "C_CURLY_BRACKET"		
		elseif lexem == "="
		...
		elseif lexem == "<="
			tkn["categ_nom"] = "OPRLR_LGT_EQ"		
		elseif lexem == "int"
			tkn["categ_nom"] = "ID_T_INT"		
		elseif lexem == "float"
			tkn["categ_nom"] = "ID_T_FLOAT"		
		elseif lexem == "char"
			tkn["categ_nom"] = "ID_T_CHAR"		
		elseif lexem == "string"
			tkn["categ_nom"] = "ID_T_STRING"		
		elseif lexem == "print"
